                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="short_description" id="short_description" cols="30" rows="10" class="summernote"  value="">{{ $product->short_description}}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <select name="brand" id="brand" class="form-control">
                                        ...
                                        @foreach ($brands as $brand)
                                            <option {{ ($brand->brand_id == $brand->id) ? 'selected' : '' }} value="{{ $brand->id}}">{{ $brand->name}}</option>
                                        @endforeach
                                    @endif
                                    </select>
                                </div>
