    ...
    <div class="container">
        ...
        <div class="row pb-3">
            ...
            <div class="col-lg-3">
                <div class="cat-card">
                    <div class="left">
                        <img src="{{ asset('uploads/category/thumb/example-category.jpg') }}" alt="" class="img-fluid">
                    </div>
                    <div class="right">
                        <div class="cat-data">
                            <h2>Category Name</h2>
                ...
                <div class="card product-card">
                    <div class="product-image position-relative">
                        <a href="product.php" class="product-img">
                            <img class="card-img-top" src="path/to/image.jpg" alt="Product Image"/>
                        </a>
                    ...
                    <div class="card-body text-center mt-3">
                        ...
                        <div class="price mt-2">
                            <span class="h5"><strong>$100.00</strong></span>
                            <span class="h6 text-underline"><del>$120.00</del></span>
                        </div>
                    </div>
                </div>
            </div>
