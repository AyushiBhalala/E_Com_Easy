                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-control">
                                <option {{ ($subCategory->showHome == 1) ? 'selected' : ''}} value="1">Active</option>
                                <option  {{ ($subCategory->showHome == 0) ? 'selected' : ''}}value="0">Block</option>
                            </select>
                            <p></p>	
                            </div>
                    </div>
...
<script>
     $('#subCategoryForm').submit(function(event){
        ...
        $("button[type=submit]").prop('disabled',true);//repeat click on create btn
