...
<head>
    ...
    <title>E_Com_Easy :: Supplier Panel</title>
                ...
                <!-- Dropdown Menu -->
                    <li class="nav-item dropdown">
                        <a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
                            <img src="{{ asset('admin-assets/img/girl1.png') }}" class="img-circle elevation-2" width="40" height="40" alt="">
                        </a>
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3">
                            ...
                            <div class="dropdown-divider"></div>
                            <a href="{{route('supplier.changePassword')}}" class="dropdown-item">
