            ...
            <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
                <div class="col-lg-4 logo">
                    <a href="#" class="text-decoration-none">
                        <span class="h1 text-uppercase text-primary bg-dark px-2">E_COM_EASY</span>
                        {{-- <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Fashion</span> --}}
                    </a>
                </div>
                <div class="col-lg-6 col-6 text-left d-flex justify-content-end align-items-center">
                    <a href="#" class="nav-link text-dark">Login/Register</a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark">
                                <li><a class="dropdown-item nav-link" href="#">Subcategory </a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 mt-3">
                            <div class="copy-right text-center">
                                <p>© Copyright 2024 Online Shop. All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
